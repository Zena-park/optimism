...
func (conf *Config) Host(log log.Logger, reporter metrics.Reporter, metrics HostMetrics) (host.Host, error) {
	...
	opts := []libp2p.Option{
		...
		// // // // // // // // // // // libp2p.MultiaddrResolver(madns.DefaultResolver), // Removed due to API changes // Removed due to API changes // Removed due to API changes // Removed due to API changes // Removed due to API changes // Removed due to API changes // Removed due to API changes // Removed due to API changes // Removed due to API changes // Removed due to API changes // Removed due to API changes - madns import removed
